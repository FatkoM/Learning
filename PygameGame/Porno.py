...
while True:
    ...
    small_text = pygame.font.Font("images\VCR_OSD_MONO_1.001.ttf", 30)
    ...
    while True:
        ...
        for event in events:
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_RETURN:
                ...
                webbrowser.open(f"https://www.pornhub.com/video/search?search={user_text}")

                tag_surface = text.render("", False,"Yellow")
                sauce_surface = text.render("", False, "Yellow")
                reuse = text.render("Would you like to play again?", False, "Red")
                
                screen.blit(reuse,(300,0))
